...
<header class="global-header">
  <nav class="navigation">
    ...
    <a href="<?php echo get_post_type_archive_link( 'post' ) ?>" aria-label="<?php esc_html_e( 'Box', 'soapatricknine' ); ?>" class="navigation__link navigation__link--hover">
    ...
    <a href="<?php echo get_post_type_archive_link( 'lab' ) ?>" aria-label="<?php esc_html_e( 'Lab', 'soapatricknine' ); ?>" class="navigation__link navigation__link--hover">
    ...
    <a href="<?php echo get_post_type_archive_link( 'factory' ) ?>" aria-label="<?php esc_html_e( 'Factory', 'soapatricknine' ); ?>" class="navigation__link navigation__link--hover">
    ...
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>patrick" aria-label="<?php esc_html_e( 'Patrick', 'soapatricknine' ); ?>" class="navigation__link navigation__link--hover navigation__link--hover__short">
      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>privacy" aria-label="<?php esc_html_e( 'Privacy', 'soapatricknine' ); ?>" class="navigation__link navigation__link--hover navigation__link--hover__short">
      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
    ...
    <button type="button" id="toggle-search-collapse" aria-label="<?php esc_html_e( 'Search', 'soapatricknine' ); ?>" class="navigation__link navigation__link--hover">
      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
